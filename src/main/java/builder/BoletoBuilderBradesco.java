...
public class BoletoBuilderBradesco implements BoletoBuilder {
    ...
    public void buildCodigoDeBarras() {
        String campoLivre = boleto.getCarteira() + boleto.getNumeroDocumento() + boleto.getAgencia() + boleto.getConta();
